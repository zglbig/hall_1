...
public class SQLWeathModel {
    ...
    public void addResource(ShopEnum shopEnum, int CommondiryId, int count) {
        ...
        switch (shopEnum) {
            case GOLD:
                ...
                break;
            case AUTO:
                checkAndAddResource(autos, CommondiryId, shopEnum.id(), count, ShopEnum.AUTO);
                break;
            case PROP:
                checkAndAddResource(props, CommondiryId, shopEnum.id(), count, ShopEnum.PROP);
                break;
        }
    }
     ...
     * @return
     */
    private boolean checkAndAddResource(List<ResourceModel> models, int commondiryId, int shopId, int count, ShopEnum shopEnum) {
        if (shopEnum == ShopEnum.AUTO) {
